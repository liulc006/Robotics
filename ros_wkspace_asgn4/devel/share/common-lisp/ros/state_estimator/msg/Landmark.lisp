...
(cl:defmethod cl:initialize-instance :after ((m <Landmark>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Landmark)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_estimator-msg:<Landmark> is deprecated: use state_estimator-msg:Landmark instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Landmark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator-msg:x-val is deprecated.  Use state_estimator-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Landmark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator-msg:y-val is deprecated.  Use state_estimator-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Landmark>)))
  ...
  (cl:format cl:nil "# The x coordinate of this landmark~%float64 x~%~%# The y coordinate of this landmark~%float64 y~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Landmark)))
  "Returns full string definition for message of type 'Landmark"
  (cl:format cl:nil "# The x coordinate of this landmark~%float64 x~%~%# The y coordinate of this landmark~%float64 y~%~%~%~%"))
